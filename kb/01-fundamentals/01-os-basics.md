...
### Процессы и потоки
#### Процесс vs поток: изоляция памяти
...
#### Состояния потока и планировщик
...
### Память и адресация
#### Виртуальная память и изоляция процессов
...
#### Файловые дескрипторы и их лимит
