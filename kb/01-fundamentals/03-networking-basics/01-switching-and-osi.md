...
#### Почему это касается TCP congestion control
...
#### Пропускная способность vs задержка распространения
...
#### Задержка передачи (transmission delay)
...
#### OSI как словарь vs TCP/IP модель на практике
...
#### Путь HTTP-запроса через уровни
...
#### OSI — не семь буквальных модулей в коде
