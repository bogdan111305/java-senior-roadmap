...
#### IPv4-адрес и маска подсети (CIDR)
...
#### Пересылка между маршрутизаторами (hop by hop)
...
#### Таблица маршрутизации и longest prefix match
...
#### IP-адрес vs MAC-адрес — не взаимозаменяемы
...
#### IP-адрес не меняется по пути (кроме NAT)
